...
export class HttpClientService {
  ...
  //uygulamada istek süreçlerinde kullanacağımız büyün url yapılanmasını burada oluşturduk. 
...
export class RequestParameters {
  ...
  headers?: HttpHeaders;
  baseUrl?: string;
  fullEndPoint?: string;  //farklı servislere de istek atabilmek için bu parametreyi ekledik.
}